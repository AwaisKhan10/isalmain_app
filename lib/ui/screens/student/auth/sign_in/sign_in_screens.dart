...
import 'package:sheduling_app/ui/screens/student/auth/sign_in/sign_in_view_model.dart';
import 'package:sheduling_app/ui/screens/teacher/auth/sign_up/sign_up_screen.dart';

class SignInStudentScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => SignInStudentViewModel(),
        child: Consumer<SignInStudentViewModel>(
